								...
								<div class="s-item-wrap">
									...
									<div class="s-item">
										...
										<div class="s-pic">
                                            ...
                                            <img src="{{$v->pic}}" alt="" class="s-pic-img s-guess-item-img">
											</a>
										</div>
										<div class="s-info">
										...
										<div class="s-tp">
											...
											<p>
                                        <form action="/collect/{{$v->cid}}" method="POST">
                                            {{csrf_field()}}
                                            {{method_field("DELETE")}}
                                            <a class="c-nodo J_delFav_btn"><input type="submit" value="取消收藏"></a>
                                        </form>
											</p>
										</div>
                                    </div>
			...
			<aside class="menu">
				<ul>
					...
					<li class="person">
						<a href="#">我的小窝</a>
						<ul>
							<li class="active"> <a href="/collect/create">收藏</a></li>

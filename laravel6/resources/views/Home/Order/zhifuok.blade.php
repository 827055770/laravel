...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head> 
  ...
  <title>付款成功页面</title> 
  <link rel="stylesheet" type="text/css" href="/static/HomeRegister/AmazeUI-2.4.2/assets/css/amazeui.css" /> 
  ...
  <link href="/static/HomeRegister/css/sustyle.css" rel="stylesheet" type="text/css" /> 
  <script type="text/javascript" src="/static/HomeRegister/basic/js/jquery-1.7.min.js"></script> 
 </head> 
 <body> 
  <!--顶部导航条 --> 
  <div class="am-container header"> 
   <ul class="message-l"> 
    <div class="topMessage"> 
     <div class="menu-hd"> 
       @if(session('username'))
        <a href="login.html" target="_top" class="h">欢迎{{session('username')}}</a> 
  ...
  <div class="nav white"> 
   ...
   <div class="logoBig"> 
    <li><img src="/static/HomeRegister/images/logobig.png" /></li> 
   </div> 

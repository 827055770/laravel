...
<div style="margin-top: 30px;width: 1068px; margin: 15px 0 30px 170px;">
    ...
    <form action="/myaddress" method="POST">
        ...
        <div style="margin-left: 150px;margin-top:-40px;">
            <textarea name="huo" style="width:500px;height: 90px;padding: 5px;" placeholder="建议您如实填写详细收货地址，例如街道 名称，门牌号码，楼层和房间号等信息"></textarea>
        </div>
        
        <div style="margin-left: 55px;margin-top: 30px;">
            <span style="color: #F2873B;">*</span>
            <span class="titles">收货人姓名:</span>
            <input type="text" name="name" placeholder="长度不超过25个字符" style="padding: 5px;width: 300px;margin-left: 14px;">
        </div>
        <div style="margin-left: 80px;margin-top: 30px;">
            <span class="titles">手机号码:</span>
            <input type="text" name="phone" placeholder="电话号码、手机号码必须填一项" style="padding: 5px;width: 200px;">
        </div>
        ...
        {{csrf_field()}}
        <input id="buttonid" style="margin-left:150px;margin-top:10px;background-color:#F37B1D ;color: #fff;width: 100px;height: 30px;border: 0px;border-radius: 5px;" type="submit" value="添加">
        </div>

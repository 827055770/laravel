...
<html>
 <head> 
  ...
  <link href="/static/HomeRegister/css/stepstyle.css" rel="stylesheet" type="text/css" /> 
  <script src="/static/HomeRegister/AmazeUI-2.4.2/assets/js/jquery.min.js" type="text/javascript"></script> 
  <script src="/static/HomeRegister/AmazeUI-2.4.2/assets/js/amazeui.js" type="text/javascript"></script> 
 </head> 
 <body> 
  <div id="header"> 
   <div class="header-layout"> 
    <div style="float:left;margin-top:-15px;"> 
     <img src="/static/Home/qi.jpg" alt="" style="height:70px" />
    </div> 

...
<html>
  ...
  <head lang="en">
    ...
    <link rel="stylesheet" href="/static/HomeRegister/AmazeUI-2.4.2/assets/css/amazeui.css" />
  ...
  <body>
    ...
    <div class="login-boxtitle">
      <a href="home.html"><img alt="logo" src="/static/HomeRegister/header-logo.png" /></a>
    </div>
      ...
      <div class="login-main">
        ...
        <div class="login-box">
            ...
            <div class="login-links">
                ...
                <a href="/register/create" class="zcnext am-fr am-btn-default">注册</a>
                <br />
            </div>
           </div>

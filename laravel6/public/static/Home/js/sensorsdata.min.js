    ...
    function(sd) {
        ...
        function() {
            ...
            function str(e, t) {
                ...
                case "object":
                    ...
                    if (rep && "object" == typeof rep) for (o = rep.length, r = 0; o > r; r += 1)"string" == typeof rep[r] && (n = rep[r], i = str(n, c), i && a.push(quote(n) + (gap ? ": ": ":") + i));
                    else for (n in c) Object.prototype.hasOwnProperty.call(c, n) && (i = str(n, c), i && a.push(quote(n) + (gap ? ": ": ":") + i));
                    return i = 0 === a.length ? "{}": gap ? "{\n" + gap + a.join(",\n" + gap) + "\n" + s + "}": "{" + a.join(",") + "}",
                    gap = s,
                    i
                }
        ...
        function() {
            ...
            i = _.each = function(t, r, i) {
                ...
                if (e && t.forEach === e) t.forEach(r, i);
                    ...
                    for (var o = 0,
                    a = t.length; a > o; o++) if (o in t && r.call(i, t[o], o, t) === n) return ! 1
                } else for (var s in t) if (hasOwnProperty.call(t, s) && r.call(i, t[s], s, t) === n) return ! 1
            };
            _.logger = logger,
            _.extend = function(e) {
                return i(slice.call(arguments, 1),
                function(t) {
            ...
            _.include = function(e, r) {
                var o = !1;
                return null == e ? o: t && e.indexOf === t ? -1 != e.indexOf(r) : (i(e,
                function(e) {
        ...
        _.strip_sa_properties = function(e) {
            ...
            function(t, r) {
                if (_.isArray(t)) {
                    ...
                    _.each(t,
                    function(e) {
                        _.isString(e) ? n.push(e) : logger.info("鎮ㄧ殑鏁版嵁-", t, "鐨勬暟缁勯噷鐨勫€煎繀椤绘槸瀛楃涓�,宸茬粡灏嗗叾鍒犻櫎")
                    }),
                    0 !== n.length ? e[r] = n: (delete e[r], logger.info("宸茬粡鍒犻櫎绌虹殑鏁扮粍"))
                }
                _.isString(t) || _.isNumber(t) || _.isDate(t) || _.isBoolean(t) || _.isArray(t) || (logger.info("鎮ㄧ殑鏁版嵁-", t, "-鏍煎紡涓嶆弧瓒宠姹傦紝鎴戜滑宸茬粡灏嗗叾鍒犻櫎"), delete e[r])
            }), e) : e
        },
        ...
        _.utf8Encode = function(e) {
            ...
            for (t = r = 0, o = e.length, n = 0; o > n; n++) {
                ...
                s = null;
                128 > a ? r++:s = a > 127 && 2048 > a ? String.fromCharCode(a >> 6 | 192, 63 & a | 128) : String.fromCharCode(a >> 12 | 224, a >> 6 & 63 | 128, 63 & a | 128),
        ...
        _.base64Encode = function(e) {
            var t, r, n, i, o, a, s, c, l = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",
            d = 0,
            u = 0,
            f = "",
            p = [];
            ...
            a = c >> 6 & 63,
            s = 63 & c,
            p[u++] = l.charAt(i) + l.charAt(o) + l.charAt(a) + l.charAt(s);
            while (d < e.length);
        ...
        _.UUID = function() {
            ...
            r = function(e) {
                ...
                var r, n, i = navigator.userAgent,
                o = [],
                a = 0;
                for (r = 0; r < i.length; r++) n = i.charCodeAt(r),
                o.unshift(255 & n),
                o.length >= 4 && (a = t(a, o), o = []);
                return o.length > 0 && (a = t(a, o)),
                a.toString(16)
            };
            return function() {
        ...
        _.draggable = function(e, t) {
            ...
            function n(t) {
                t = t || window.event;
                var n = r();
                e.style.left = t.clientX + n.x - d + "px",
                e.style.top = t.clientY + n.y - u + "px",
                t.stopPropagation ? t.stopPropagation() : t.cancelBubble = !0
            }
            function i(e) {
                e || (e = window.event),
                document.removeEventListener ? (document.removeEventListener("mouseup", i), document.removeEventListener("mousemove", n)) : document.detachEvent && (document.detachEvent("onmouseup", i), document.detachEvent("onmousemove", n)),
            ...
            d = a - c,
            u = s - l;
            document.addEventListener ? (document.addEventListener("mousemove", n), document.addEventListener("mouseup", i)) : document.attachEvent && (document.attachEvent("onmousemove", n), document.attachEvent("onmouseup", i)),
            t.stopPropagation ? t.stopPropagation() : t.cancelBubble = !0,
        ...
        _.bindReady = function(e) {
            ...
            if (document.addEventListener) document.addEventListener("DOMContentLoaded", t, !1);
                ...
                document.documentElement.doScroll && !i && r(),
        ...
        _.addEvent = function() {
            ...
            var r = function(t, r, n) {
                if (t && t.addEventListener) t.addEventListener(r, n, !1);
                else {
                    var i = "on" + r,
                    o = t[i];
                    t[i] = e(t, n, o)
        ...
        _.cookie = {
            ...
            set: function(e, t, r, n, i) {
                ...
                a = "",
                s = "";
                if (r = "undefined" == typeof r ? 73e3: r, n) {
                    var c = _.url("domain", location.href);
                    o = c ? "; domain=." + c: ""
                }
                if (0 !== r) {
                    var l = new Date;
                    "s" === String(r).slice( - 1) ? l.setTime(l.getTime() + 1e3 * Number(String(r).slice(0, -1))) : l.setTime(l.getTime() + 24 * r * 60 * 60 * 1e3),
                    a = "; expires=" + l.toGMTString()
                }
                i && (s = "; secure"),
                document.cookie = e + "=" + encodeURIComponent(t) + a + "; path=/" + o + s
            },
            remove: function(e, t) {
        ...
        _.ajax = function(e) {
            ...
            try {
                if (r.withCredentials = !0, _.isObject(e.header)) for (var n in e.header) r.setRequestHeader(n, e.header[n]);
        ...
        _.url = function() {
            ...
            function n(e, r) {
                for (var n = e.charAt(0), i = r.split("&"), o = [], a = {},
                s = [], c = e.substring(1), l = 0, d = i.length; d > l; l++) if (o = i[l].match(/(.*?)=(.*)/), o || (o = [i[l], i[l], ""]), "" !== o[1].replace(/\s/g, "")) {
                    if (o[2] = t(o[2] || ""), c === o[1]) return o[2];
                    s = o[1].match(/(.*)\[([0-9]+)\]/),
                    s ? (a[s[1]] = a[s[1]] || [], a[s[1]][s[2]] = o[2]) : a[o[1]] = o[2]
                }
                return n === e ? a: a[c]
            }
            return function(t, i) {
                ...
                if (t = t.toString(), o = i.match(/^mailto:([^\/].+)/)) a.protocol = "mailto",
                a.email = o[1];
                else {
                    ...
                    e() && (o = a.hostname.match(e()), o && (a.tld = o[3], a.domain = o[2] ? o[2] + "." + o[3] : void 0, a.sub = o[1] || void 0)),
        ...
        _.getReferrer = function(e) {
            ...
            return 0 === e.indexOf("https://www.baidu.com/") && (e = e.split("?")[0]),
        ...
        sd.sendState.getSendCall = function(e, t) {++this._receive;
            var r = "_state" + this._receive,
            n = this;
            this[r] = document.createElement("img"),
            this[r].onload = this[r].onerror = function(e) {
                n[r].onload = null,
                n[r].onerror = null,
                delete n[r],
                ++n._complete,
            ...
            logger.info(e),
            e = JSON.stringify(e),
            sd.is_heatmap_render_mode ? this[r].src = sd.para.server_url: -1 !== sd.para.server_url.indexOf("?") ? this[r].src = sd.para.server_url + "&data=" + encodeURIComponent(_.base64Encode(e)) : this[r].src = sd.para.server_url + "?data=" + encodeURIComponent(_.base64Encode(e))
        };
        var saNewUser = {
        ...
        saEvent.checkOption = {
            ...
            str: function(e) {
                return _.isString(e) ? !0 : (logger.info("璇锋鏌ュ弬鏁版牸寮�,蹇呴』鏄瓧绗︿覆"), !0)
            },
            properties: function(e) {
                return _.strip_sa_properties(e),
                e ? _.isObject(e) ? this.checkPropertiesKey(e) ? !0 : (logger.info("properties閲岀殑key蹇呴』鏄敱瀛楃涓叉暟瀛梍缁勬垚锛屼笖涓嶈兘鏄郴缁熶繚鐣欏瓧"), !0) : (logger.info("properties鍙互娌℃湁锛屼絾鏈夌殑璇濆繀椤绘槸瀵硅薄"), !0) : !0
            },
            propertiesMust: function(e) {
                return _.strip_sa_properties(e),
                void 0 === e || !_.isObject(e) || _.isEmptyObject(e) ? (logger.info("properties蹇呴』鏄璞′笖鏈夊€�"), !0) : this.checkPropertiesKey(e) ? !0 : (logger.info("properties閲岀殑key蹇呴』鏄敱瀛楃涓叉暟瀛梍缁勬垚锛屼笖涓嶈兘鏄郴缁熶繚鐣欏瓧"), !0)
            },
            event: function(e) {
                return _.isString(e) && this.regChecks.regName.test(e) ? !0 : (logger.info("璇锋鏌ュ弬鏁版牸寮�,蹇呴』鏄瓧绗︿覆,涓攅ventName蹇呴』鏄瓧绗︿覆_寮€澶�,涓斾笉鑳芥槸绯荤粺淇濈暀瀛�"), !0)
            },
            test_id: "str",
            group_id: "str",
            distinct_id: function(e) {
                return _.isString(e) && /^.{1,255}$/.test(e) ? !0 : (logger.info("distinct_id蹇呴』鏄笉鑳戒负绌猴紝涓斿皬浜�255浣嶇殑瀛楃涓�"), !1)
            }
        },
        ...
        saEvent.send = function(e, t) {
            ...
            sd.para.debug_mode === !0 ? (logger.info(r), this.debugPath(JSON.stringify(r), t)) : sd.sendState.getSendCall(r, t)
        },
        saEvent.debugPath = function(e, t) {
            ...
            _.ajax({
                ...
                success: function(e) {
                    _.isEmptyObject(e) === !0 ? alert("debug鏁版嵁鍙戦€佹垚鍔�" + r) : alert("debug澶辫触 閿欒鍘熷洜" + JSON.stringify(e))
                }
            })
        };
        var store = sd.store = {
            ...
            toState: function(e) {
                var t = null;
                if (null != e && _.isJSONString(e)) if (t = JSON.parse(e), t.distinct_id) {
                    if (this._state = t, "object" == typeof t.props) {
            ...
            getCookieName: function() {
                var e = "";
                return sd.para.cross_subdomain === !1 ? (e = _.url("sub", location.href), e = "string" == typeof e && "" !== e ? "sa_jssdk_2015_" + e: "sa_jssdk_2015_root") : e = "sensorsdata2015jssdkcross",
                e
            },
            init: function() {
                navigator.cookieEnabled || (error_msg.push("cookieNotEnable"), _.localStorage.isSupport || error_msg.push("localStorageNotEnable")),
                this.initSessionState();
                var e = _.cookie.get(this.getCookieName());
                null === e ? (is_first_visitor = !0, just_test_distinctid = 1, this.set("distinct_id", _.UUID())) : (just_test_distinctid = 2, just_test_distinctid_detail = JSON.stringify(e), just_test_distinctid_detail2 = navigator.userAgent + "^_^" + document.cookie, this.toState(e)),
        ...
        commonWays = {
            ...
            allTrack: function() {
                return document && document.body ? sd.para.heatmap ? !1 : (sd.para.heatmap = {},
                heatmap.init(), !1) : (setTimeout(this.allTrack, 1e3), !1)
            },
        ...
        _.trackLink = function(e, t, r) {
            ...
            e = e || {};
            var i = null;
            return e.ele && (i = e.ele),
            e.event && (i = e.event.target),
            r = r || {},
            i && "object" == typeof i ? !i.href || /^javascript/.test(i.href) || i.target ? (sd.track(t, r), !1) : (e.event && n(e.event), void(e.ele && _.addEvent(e.ele, "click",
            function(e) {
                n(e)
            }))) : !1
        },
        ...
        sd.trackLinks = function(e, t, r) {
            return r = r || {},
            e && "object" == typeof e ? !e.href || /^javascript/.test(e.href) || e.target ? !1 : void _.addEvent(e, "click",
            function(n) {
                function i() {
        ...
        sd.identify = function(e, t) {
            ...
            "undefined" == typeof e ? r ? store.set("first_id", _.UUID()) : store.set("distinct_id", _.UUID()) : saEvent.check({
                distinct_id: e
            }) ? t === !0 ? r ? store.set("first_id", e) : store.set("distinct_id", e) : r ? store.change("first_id", e) : store.change("distinct_id", e) : logger.info("identify鐨勫弬鏁板繀椤绘槸瀛楃涓�")
        },
        ...
        sd.logout = function(e) {
            var t = store.getFirstId();
            t ? (store.set("first_id", ""), e === !0 ? store.set("distinct_id", _.UUID()) : store.set("distinct_id", t)) : logger.info("娌℃湁first_id锛宭ogout澶辫触")
        };
        var heatmap_render = {
            showErrorInfo: function(e, t) {
                var r = document.createElement("div");
                r.setAttribute("style", "background:#e55b41;border:none;border-radius:8px;color:#fff;font-size:18px;left:50%;margin-left:-300px;padding:15px;position: fixed;text-align: center;top: 0;width:600px;z-index:9999;"),
                1 === e ? r.innerHTML = "褰撳墠椤甸潰鍦ㄦ墍閫夋椂闂存鍐呮殏鏃舵病鏈夌偣鍑绘暟鎹�": 2 === e ? t.error ? r.innerHTML = t.error: r.innerHTML = "璇锋眰鏁版嵁寮傚父鎴栬€呯紦瀛樿秴鏃�": 3 === e ? r.innerHTML = "褰撳墠椤甸潰鍦ㄦ墍閫夋椂闂存鍐呮殏鏃舵病鏈夌偣鍑绘暟鎹�": 4 === e && (t.error ? r.innerHTML = t.error: r.innerHTML = "璇锋眰鏁版嵁寮傚父鎴栬€呯紦瀛樿秴鏃�"),
            ...
            getRequestInfo: function(e, t) {
                ...
                if ("string" == typeof e && sd.para.web_url) {
                    ...
                    var i = new _.urlParse(sd.para.web_url);
                    i._values.Path = "/api/heat_map/report/path/" + e,
                    t ? (this.requestType = 3, _.ajax({
                        url: i.getUrl() + "?pathUrl=" + t,
                        type: "POST",
                        cors: !0,
                        header: {
                            cors: "true"
                        ...
                        success: function(e) {
                            r.bindEffect(),
                            r.calculateHeatData(e)
                        },
                        error: function(e) {
                            r.showErrorInfo(2, e),
                            sessionStorage.removeItem("sensors_heatmap_id"),
                            0 === location.href.indexOf("http://www.notrack.com:8080/sdk_test.html") && (r.bindEffect(), r.calculateHeatData(window.data_sa_heat_test_data_test_201703130440 || {}))
                        }
                ...
                } else _.logger.info("缂哄皯web_url")
            },
            calculateHeatData: function(e) {
                var t = this;
                if (!_.isObject(e) || !_.isArray(e.rows) || !_.isObject(e.rows[0])) return t.showErrorInfo(t.requestType),
                !1;
                ...
                _.each(e,
                function(e) {
                    e.by_values[0] && document.querySelectorAll(e.by_values[0])[0] && o.push(e)
                }),
                0 === o.length && t.showErrorInfo(t.requestType),
                e = o,
                _.each(e,
                function(e, t) {
                    e.value_fix = e.values[0][0],
                    i += e.value_fix
                }),
                t.data_render = e,
                _.each(e,
                function(e, o) {
                    if (e.by_values[0]) {
                        e.data_page_percent = Number(e.value_fix / i * 100).toFixed(2) + "%",
                        e.data_click_percent = Number(e.value_fix / r * 100).toFixed(2) + "%",
                        e.data_click = Number(e.value_fix / r),
                        e.data_page = Number(e.value_fix / i);
                        var a = new _.urlParse(sd.para.web_url);
                        a._values.Path = "/web-click/users/#heat_map_id=" + n + "&element_selector=" + encodeURIComponent(e.by_values[0]),
                        e.data_user_link = a.getUrl(),
                        "null" === String(e.top_values[0]) ? e.data_top_value = "娌℃湁鍊�": e.data_top_value = String(e.top_values[0]);
                        var s = document.querySelectorAll(e.by_values[0]);
                        "object" == typeof s && s.length > 0 && t.renderHeatData(s, e, o)
                    }
                })
            },
            heatData: function(e) {
                for (var t = [.005, .01, .025, .05, .1, .5], r = 0; r < t.length; r++) if (e < t[r]) return r;
                return 8
            },
            heatDataTitle: function(e) {
                return "鐐瑰嚮娆℃暟 " + e.value_fix + "\r\n鐐瑰嚮姒傜巼 " + e.data_click_percent + "\r\n鐐瑰嚮鍗犳瘮 " + e.data_page_percent + "\r\n鍘嗗彶鏁版嵁 " + String(e.top_values[0]).slice(0, 30)
            },
            renderHeatData: function(e, t, r) {
                var n = _.ry(e[0]);
                n.attr("data-heat-place", String(r)).addClass("sa-click-area").attr("data-click", t.data_click_percent).addClass("sa-click-area" + this.heatData(t.data_click)),
                "inline" === n.getStyle("display") && (e[0].style.display = "inline-block")
            },
            is_fix_state: null,
            showEffectBox: function(e, t, r) {
                if ("fixslidedown" === this.is_fix_state) t.style.position = "fixed",
                t.style.left = "auto",
                t.style.right = 0,
                t.style.top = 0,
                r && (t.className = "sa-heat-box-effect-2017314");
                    ...
                    s = o.left + a.width + 2,
                    c = o.top + 1;
                    s + 220 > n && (s = o.left - 220, o.left < 220 && (s = e.pageX)),
            ...
            bindEffect: function() {
                function e(e) {
                    r = e;
                    var t = e.target,
                    n = t.getAttribute("data-heat-place"),
                    l = i.data_render[n];
                    if (!l) return ! 1;
                    var d = _.trim(t.textContent);
                    d && (d = d.replace(/[\r\n]/g, " ").replace(/[ ]+/g, " ").substring(0, 255)),
                    l.data_current_content = d || "娌℃湁鍊�",
                    a = o.replace(/\{\{[^\{\{]+\}\}/g,
                    function(e) {
                        return e = e.slice(2, -2),
                        "string" == typeof e && "object" == typeof l ? l[e] : void 0
                    }),
                    f.innerHTML = a,
                    i.showEffectBox(e, c, s)
                }
                function t(t) {
                    var r = t.target;
                    setTimeout(function() {
                ...
                m = document.getElementById("sa_heat_float_right_box_left_btn");
                _.addEvent(c, "mouseleave",
                function() {
                    n = !1,
                    c.style.display = "none"
                }),
                _.addEvent(c, "mouseenter",
                function() {
                    n = !0
                }),
                _.addEvent(l, "mousedown",
                function(e) {
                    "sa_heat_float_right_box_slidedown" === e.target.id && _.draggable(c, e)
                }),
                _.addEvent(u, "mousedown",
                function(e) {
                ...
                function(e) {
                    ...
                    i.is_fix_state = "notfix",
                    _.cookie.set("sensorsdata_heatmap_float_fix_state", "notfix"),
                    i.showEffectBox(r, c, s)
                }),
                _.addEvent(h, "click",
                function(e) {
                    u.style.display = "block",
                    l.style.display = "none",
                    i.is_fix_state = "fixslidedown",
                ...
                _.addEvent(c, "animationend",
                function() {
                    c.className = ""
                });
                var v = _.cookie.get("sensorsdata_heatmap_float_fix_state");
                null === v ? this.is_fix_state = "notfix": this.is_fix_state = v,
                "notfix" === this.is_fix_state ? (l.style.display = "block", u.style.display = "none", d.style.display = "none") : "fixslidedown" === this.is_fix_state ? (d.style.display = "none", l.style.display = "none", u.style.display = "block") : "fixslideup" === this.is_fix_state && (s = !1, c.style.width = "70px", c.style.height = "30px", f.style.display = "none", d.style.display = "block", l.style.display = "none", u.style.display = "none");
                var b = 600,
                y = null;
                _.addEvent(document, "mouseover",
                function(e) {
                    var r = e.target,
                    i = r.className;
                    return y = r,
                    "string" != typeof i || -1 === (" " + i + " ").indexOf(" sa-click-area ") ? !1 : (r.onmouseleave = function() {
                        setTimeout(function() {
                            n || (n = !1, c.style.display = "none")
                        },
                        b)
                    },
                    void t(e))
        ...
        heatmap = {
            ...
            prepare: function(e) {
                function t(e, t) {
                    return document.querySelectorAll ? (heatmap_render.setCssStyle(), heatmap_render.getRequestInfo(e, t), void n.sendIframeData()) : (alert("璇锋洿鏂板埌鏈€鏂扮増娴忚鍣�,寤鸿鐢╟hrome鎴栬€協irefox"), !1)
                }
            ...
            init: function() {
                ...
                function(t) {
                    ...
                    return "body" === i.toLowerCase() || "html" === i.toLowerCase() ? !1 : n && n.parentNode && n.parentNode.children ? void e.start(r, n, i) : !1
                }) : _.addEvent(document, "click",
                function(t) {
                    var r = t || window.event,
                    n = r.target || r.srcElement,
                    i = n.tagName.toLowerCase();
                    return "body" === i.toLowerCase() || "html" === i.toLowerCase() ? !1 : n && n.parentNode && n.parentNode.children ? void(("button" === i || "a" === i || "input" === i || "textarea" === i) && e.start(r, n, i)) : !1
                }))) : !1
            }
        };
        sd.init = function() {
